...
abstract class EasyTabBarTxtImgImp extends RelativeLayout {
    ...
    public EasyTabBarTxtImgImp(Context context) {
        super(context);
        this.context = context;
    }

    public EasyTabBarTxtImgImp(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initAttrs(attrs, 0);
        initView();
    ...
    public EasyTabBarTxtImgImp(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
