...
abstract class EasyTabBarBottomManager extends RelativeLayout {
    ...
    private void initAttrs(AttributeSet attrs, int defStyleAttr) {
        ...
        String txt2 = a.getString(R.styleable.EasyTabBarBottom_text2);
        String txt3 = a.getString(R.styleable.EasyTabBarBottom_text3);
        String txt4 = a.getString(R.styleable.EasyTabBarBottom_text4);
        txts[0] = txt0;
        txts[1] = txt1;
        txts[2] = txt2;
        txts[3] = txt3;
        ...
        Drawable img0_0 = a.getDrawable(R.styleable.EasyTabBarBottom_img0_0);
        Drawable img0_1 = a.getDrawable(R.styleable.EasyTabBarBottom_img0_1);
        Drawable img1_0 = a.getDrawable(R.styleable.EasyTabBarBottom_img1_0);
        Drawable img1_1 = a.getDrawable(R.styleable.EasyTabBarBottom_img1_1);
        Drawable img2_0 = a.getDrawable(R.styleable.EasyTabBarBottom_img2_0);
        Drawable img2_1 = a.getDrawable(R.styleable.EasyTabBarBottom_img2_1);
        Drawable img3_0 = a.getDrawable(R.styleable.EasyTabBarBottom_img3_0);
        Drawable img3_1 = a.getDrawable(R.styleable.EasyTabBarBottom_img3_1);
        Drawable img4_0 = a.getDrawable(R.styleable.EasyTabBarBottom_img4_0);
        Drawable img4_1 = a.getDrawable(R.styleable.EasyTabBarBottom_img4_1);
        imgs_0[0] = img0_0;
        imgs_0[1] = img1_0;
        imgs_0[2] = img2_0;
        imgs_0[3] = img3_0;
