 ...
 * 时间：2017/8/12.
 */
abstract class EasyDialogManager extends Dialog implements View.OnClickListener {
    ...
    EasyDialogManager(@NonNull Context context) {
        super(context);
        this.context = context;
    }

    EasyDialogManager(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
        this.context = context;
    }

    EasyDialogManager(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
