...
//        mLeftTextWithLeftImg = ta.getDrawable(R.styleable.EasyTopBar_leftTextWithImg);
        ...
        isShowLeftImage = ta.getBoolean(R.styleable.EasyTopBar_showLeftImage, true);
...
//        isShowFaceLeftImage = ta.getBoolean(R.styleable.EasyTopBar_showLeftFaceImage, false);
        ...
        mBottomLineColor = ta.getColor(R.styleable.EasyTopBar_topBarBottomLineColor, 0xfff4f4f4);
    ...
    private void initView() {
        ...
        if (mLeftImage != null) {
            ...
            ivLeft.setImageDrawable(getResources().getDrawable(R.drawable.icon_back));
        }
        ivLeft.setVisibility(isShowLeftImage ? VISIBLE : GONE);
        ...
        viewLine.setBackgroundColor(mBottomLineColor);
