...
public class StringScrollPicker extends ScrollPickerView<CharSequence> {
    ...
    public StringScrollPicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        init(attrs);
        setData(new ArrayList<CharSequence>(Arrays.asList("one", "two", "three", "four", "five",
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mMinTextSize = typedArray.getDimensionPixelSize(
                    R.styleable.StringScrollPicker_ScrollPickerMinTextSize, mMinTextSize);
            mMaxTextSize = typedArray.getDimensionPixelSize(
                    R.styleable.StringScrollPicker_ScrollPickerMaxTextSize, mMaxTextSize);
            mStartColor = typedArray.getColor(
                    R.styleable.StringScrollPicker_ScrollPickerStartColor, mStartColor);
            mEndColor = typedArray.getColor(
                    R.styleable.StringScrollPicker_ScrollPickerEndColor, mEndColor);
            mMaxLineWidth = typedArray.getDimensionPixelSize(R.styleable.StringScrollPicker_ScrollPickerMaxLineWidth, mMaxLineWidth);
            int align = typedArray.getInt(R.styleable.StringScrollPicker_ScrollPickerAlignment, 1);
            if (align == 2) {
