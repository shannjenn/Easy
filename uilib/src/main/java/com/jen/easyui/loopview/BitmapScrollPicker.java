    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mDrawMode = typedArray.getInt(
                    R.styleable.BitmapScrollPicker_ScrollPickerBitmapMode, mDrawMode);
            mSpecifiedSizeWidth = typedArray.getDimensionPixelOffset(
                    R.styleable.BitmapScrollPicker_ScrollPickerDrawBitmapWidth, mSpecifiedSizeWidth);
            mSpecifiedSizeHeight = typedArray.getDimensionPixelOffset(
                    R.styleable.BitmapScrollPicker_ScrollPickerDrawBitmapHeight, mSpecifiedSizeHeight);
            mMinScale = typedArray.getFloat(R.styleable.BitmapScrollPicker_ScrollPickerMinScale, mMinScale);
            mMaxScale = typedArray.getFloat(R.styleable.BitmapScrollPicker_ScrollPickerMaxScale, mMaxScale);
            typedArray.recycle();
        }
    }
