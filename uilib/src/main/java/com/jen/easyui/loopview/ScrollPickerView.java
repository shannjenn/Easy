...
public abstract class ScrollPickerView<T> extends View {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            if (typedArray.hasValue(R.styleable.ScrollPickerView_ScrollPickerCenterItemBackground)) {
                setCenterItemBackground(typedArray.getDrawable(R.styleable.ScrollPickerView_ScrollPickerCenterItemBackground));
            }
            setVisibleItemCount(typedArray.getInt(R.styleable.ScrollPickerView_ScrollPickerVisibleItemCount, getVisibleItemCount()));
            setCenterPosition(typedArray.getInt(R.styleable.ScrollPickerView_ScrollPickerCenterItemPosition, getCenterPosition()));
            setIsCirculation(typedArray.getBoolean(R.styleable.ScrollPickerView_ScrollPickerIsCirculation, isIsCirculation()));
            setDisallowInterceptTouch(typedArray.getBoolean(R.styleable.ScrollPickerView_ScrollPickerDisallowInterceptTouch, isDisallowInterceptTouch()));
            setHorizontal(typedArray.getInt(R.styleable.ScrollPickerView_ScrollPickerOrientation, mIsHorizontal ? 1 : 2) == 1);
            typedArray.recycle();
        }
    }
