...
public class EasyLetterViewManager extends View {
    //    private String TAG = EasyLetterView.class.getSimpleName();
...
//    private int spacingBottom;//垂直间距（底部）
    ...
    public EasyLetterViewManager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initAttrs(context, attrs);
    }

    public EasyLetterViewManager(Context context, AttributeSet attrs, int defStyleAttr) {
