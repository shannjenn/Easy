...
class EasyDBDaoMan {
     ...
     * @return
     */
    static Object searchById(Class clazz, String id) {
        ...
        SQLiteDatabase db = DBHelperMan.getInstance().getReadDatabse();
     ...
     * @return
     */
    static List<Object> searchByWhere(Class clazz, String selection, String[] selectionArgs, String orderBy, int page, int pageNo) {
     ...
     * @param obj
     */
    static void replace(Object obj) {
        if (obj == null) {
            DBLog.w("obj is null");
            return;
        }
     ...
     * @param id
     */
    static void delete(Class clazz, String id) {
        if (clazz == null) {
            DBLog.w("obj is null");
            return;
        }
    ...
    static void delete(Class clazz, String selection, String[] selectionArgs) {
        if (clazz == null || selection == null || selectionArgs == null || selectionArgs.length == 0) {
     ...
     * @param bindArgs 参数的值
     */
    static void execSQL(String sql, String[] bindArgs) {
        SQLiteDatabase db = DBHelperMan.getInstance().getReadDatabse();
        try {
            db.beginTransaction();
            db.execSQL(sql);
